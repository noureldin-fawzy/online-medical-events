...
class GlobalSearchController extends Controller
{
    private $models = [
        ...
        'Topic'            => 'cruds.topic.title',
        'Board'            => 'cruds.board.title',
        'Speaker'          => 'cruds.speaker.title',
        'Schedule'         => 'cruds.schedule.title',
        'Sponsor'          => 'cruds.sponsor.title',
        'Exhibition'       => 'cruds.exhibition.title',
        'ExhibitionDetail' => 'cruds.exhibitionDetail.title',
        'Specialty'        => 'cruds.specialty.title',
        'Contact'          => 'cruds.contact.title',
        'Organizer'        => 'cruds.organizer.title',
    ];
