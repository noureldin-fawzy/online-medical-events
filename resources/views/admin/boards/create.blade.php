    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.boards.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="events">{{ trans('cruds.board.fields.event') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.board.fields.event_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required">{{ trans('cruds.board.fields.type') }}</label>
                <select class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" name="type" id="type" required>
                    <option value disabled {{ old('type', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                    @foreach(App\Models\Board::TYPE_SELECT as $key => $label)
                ...
                @endif
                <span class="help-block">{{ trans('cruds.board.fields.type_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="required" for="image">{{ trans('cruds.board.fields.image') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.board.fields.image_helper') }}</span>
            </div>
            <div class="form-group">
                <div class="form-check {{ $errors->has('active') ? 'is-invalid' : '' }}">
                    ...
                    <label class="form-check-label" for="active">{{ trans('cruds.board.fields.active') }}</label>
                </div>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.board.fields.active_helper') }}</span>
            </div>
            <div class="form-group">
